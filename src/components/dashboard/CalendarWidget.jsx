...
const CalendarWidget = () => {
  return (
    <div className="col-span-full xl:col-span-6 bg-white rounded-lg shadow-lg border border-slate-200 ">
                                        ...
                                        <td>
                                            <div className="w-full h-full">
                                                <div className="flex items-center justify-center w-full rounded-full cursor-pointer">
                                                    <p className="text-2xl w-14 h-14 flex items-center justify-center font-medium text-white bg-blue-700 rounded-full">8</p>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
