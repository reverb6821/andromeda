    ...
    return(
        <React.Fragment>
            <footer className="color-primary fixed bottom-0 left-0 z-20 w-full shadow-lg">
                ...
                <div className="text-sm  sm:text-center text-color">© {t("t.app.layout.partials.footer.date", { date: new Date() })}  <a href="" className="hover:underline">{footerTitle}</a>. All Rights Reserved.
                </div>
                <ul className="flex flex-wrap items-center mt-3 text-sm font-medium text-color sm:mt-0">
