...
import SidebarProperties, { SideNavItem } from './Sidebar.properties';

const Sidebar: React.FC<SidebarProperties> = ({ children, sidebarLogo, sidebarTitle, sidebarSubTitle, items }) => {
